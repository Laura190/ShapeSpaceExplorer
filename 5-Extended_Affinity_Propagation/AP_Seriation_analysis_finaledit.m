function [ wish_list, idx ] = AP_Seriation_analysis_finaledit(shape_distance_vector,RAMeff,savedestination)
%AP_SERIATION_ANALYSIS Summary of this function goes here
...
%   RAMeff should be a binary indicator (0 or 1) indicating whether or not
%   you want to use RAM efficiency mode, with large matrices this should be
%   used
...
exems=unique(idx);
exem_idx=Corr_wish_mat( W, savedestination ,exems );
wish_list=exems(exem_idx);
save([savedestination '/wish_list.mat'], 'wish_list','-v7.3')
end
